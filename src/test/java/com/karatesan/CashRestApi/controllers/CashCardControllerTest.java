...
public class CashCardControllerTest {
	...
	void shouldCreateNerwCard() {
		...
		ResponseEntity<Void> createResponseEntity = restTemplate.postForEntity("/cashcards", card, Void.class);
		...
		ResponseEntity<String> getResponse = restTemplate.getForEntity(locationOfNewCashCardUri, String.class);
		assertThat(getResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
